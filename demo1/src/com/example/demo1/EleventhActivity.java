...
public class EleventhActivity extends Activity{
	...
	private void findView() {
		...
		int Size =new DBHelper(EleventhActivity.this).Size();
		List<Zclb> list=new DBHelper(EleventhActivity.this).find();
	   ...
	   tv1.setOnClickListener(new OnClickListener() {
           ...
           public void onClick(View v) {
               AlertDialog.Builder localBuilder = new AlertDialog.Builder(EleventhActivity.this);
...
btn1.setOnClickListener(new OnClickListener(){
	  int Size =new DBHelper2(EleventhActivity.this).Size();
	  List<Zc> list=new DBHelper2(EleventhActivity.this).find();
	 @Override
	   public void onClick(View v) {
		 tv.setText("");
		 float num2=0;
		...
		if(ckb1.isChecked()){
			if(ckb2.isChecked()){
				for(int i=0;i<Size;i++){
				    ...
				    if(list.get(i).getZclb().equals(TypeResult)&&jg1>0&&jg2>0){
				    	float num1 = Integer.valueOf(list.get(i).getZcje()).intValue();
	                    num5+=num1;
	                    tv.setText("总支出金额为"+num5+"\n"); 				
	                    Toast.makeText(EleventhActivity.this, "查询数据如下", Toast.LENGTH_SHORT).show();	
					}
		      }
			}else{
				 for(int i=0;i<Size;i++){
...
btn2.setOnClickListener(new OnClickListener(){
	 @Override
	   public void onClick(View v) {
		 Intent intent = new Intent(EleventhActivity.this,SecondActivity.class);
